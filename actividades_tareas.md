# Actividades y Tareas por Módulo

## Distribución de Horas: Marco General

- **Total**: 192 horas (4 créditos × 48h).
- **Contacto directo**: ~30 horas (15 semanas × 2h/semana).
- **Trabajo independiente**: ~162 horas.
- **Desglose por módulo** (horas independientes):
  - Módulo 1 (Fund): ~50h
...
## Módulo 1: Fundamentos de Investigación Científica (Sem 1–3)

### Objetivos
- Formular preguntas clínicas en términos investigativos contestables.
- Dominar búsqueda bibliográfica en PubMed y Rayyan.
- Entender la estructura PICO.

### Sesiones Sincrónicas (6h total)
...
2. **Búsqueda Documentada** (~10 horas):
   - Para ≥2 de tus preguntas PICO, ejecuta búsqueda en PubMed.
   - Documenta: estrategia de búsqueda (términos MeSH, booleano), número de resultados, filtros aplicados.
   - Selecciona ≥1 artículo por pregunta que conteste (parcial o completamente) tu PICO.
   - Importa referencias a Rayyan, etiqueta, guarda.
   - Entrega: screenshot de PubMed + Rayyan, documento de estrategia (1–2 páginas).

#### Reflexión (≈15 horas)
- **Journal semanal** (3 entradas de 1–2 párrafos c/u; opcional, pero altamente recomendado):
  - Sem 1: ¿Cuál fue tu primera reacción a la estructura PICO? ¿Qué pregunta clínica te hace más curiosidad?
  - Sem 2: Experiencia en búsqueda bibliográfica — ¿fácil o frustrante? ¿Qué aprendiste?
  - Sem 3: Reflexión: ¿cómo has visto investigación en la clínica? ¿Qué papel juega en tu práctica futura?
...
## Módulo 2: Diseños de Estudio (Sem 4–7)

### Objetivos
- Clasificar y comparar diseños (descriptivo, cohorte, caso-control, RCT, revisión sistemática).
- Reconocer fortalezas, limitaciones, sesgos.
- Aplicar a ejemplos reales en urología.

### Sesiones Sincrónicas (8h total)
...
1. **Matriz Comparativa de Diseños** (~12 horas):
   - Plantilla entregada; estudiante completa:
     - Diseño (transversal, cohorte, caso-control, RCT, revisión sistemática).
     - Definición (~1 línea).
     - Fortalezas (~2–3 líneas).
     - Limitaciones (~2–3 líneas).
     - Sesgos comunes (~2).
...
2. **Análisis de Estudios Reales** (~18 horas):
   ...
   - Para cada uno:
     - Resumen ejecutivo (1 párrafo): pregunta, diseño, población, resultado principal.
     - Identificación de fortalezas (≥2) y limitaciones (≥2).
     - Evaluación de sesgo: ¿qué sesgo amenaza validez? ¿con qué magnitud?
     - Conclusión: ¿es válido? ¿cuán aplicable a mi contexto (Univalle)?
   - Formato: 1 página por estudio, total 4 páginas, entrega en PDF.

#### Reflexión (≈10 horas)
- **Journal reflexivo** (3 entradas):
  - Sem 4: ¿Cuál es el diseño más "fácil"? ¿Cuál el más riguroso? ¿Cuál elegirías para tu pregunta PICO?
  - Sem 5–6: Reflexión sobre sesgo: ¿qué sesgo te sorprendió más? ¿Cómo afecta a tus lecturas clínicas?
  - Sem 7: Síntesis: ¿cuándo una revisión sistemática es mejor que un solo RCT? ¿Y cuándo un RCT es insuficiente?

#### Apoyo
- Plantilla de matriz interactiva (LMS).
- Guía de lectura para cada estudio (qué buscar, anotaciones sugeridas).
- Taller asincrónico: "Cómo analizar fortalezas y limitaciones" (video, 12 min).
- Foro: preguntas sobre diseños (tutor responde 24–48h).

---

## Módulo 3: Ética e Integridad en Investigación (Sem 8–10)

### Objetivos
- Explicar principios éticos (autonomía, beneficencia, justicia).
- Describir rol de comités de ética.
- Reconocer y evitar malas prácticas.
- Aplicar criterios éticos a casos reales.
...
2. **Integridad en Investigación** (~8 horas):
   ...
   - Tarea: identifica qué está mal (falta comillas, paráfrasis sin cita, autocita inflada, etc.) y corrígelo.
   - Formato: tabla de 5 filas (original | error ético | corrección), entrega Word.
   - Lectura de apoyo: guía de citación Harvard o APA (1 página).
...
- Guía de lectura para cada caso (preguntas directrices).
- Plantilla de reporte ético (estructura: resumen, análisis, recomendación, referencias).
- Taller asincrónico: "Cómo citar y evitar plagio" (video, 10 min, Mendeley demo).
- Oficina horas: ética, integridad, preguntas sobre casos.
...
- Entender niveles de evidencia y grados de recomendación.
- Aplicar bioestadística conceptual.
- Comunicar síntesis de evidencia.
...
- **Journal reflexivo** (3 entradas + preparación presentación):
  - Sem 11: Experiencia con CASP: ¿fácil de usar? ¿Qué preguntas fueron más desafiantes?
  - Sem 12: Reflexión: ¿cómo cambiaría tu práctica clínica si entendieras mejor niveles de evidencia?
  - Sem 13: Síntesis previa a journal club: tema seleccionado, por qué interesa, primeras impresiones de artículos.

#### Apoyo
- Herramientas CASP descargables (plantillas PDF, 1 página c/u por diseño).
- Video tutorial CASP (Univalle LMS, 8 min).
- Plantilla de bioestadística (Excel con fórmulas; cálculos semi-automatizados).
- Guía de lectura para cada artículo (ej. "¿Cuál es el resultado primario? ¿Cuál es el p-valor?").
- Foro: preguntas sobre appraisal, bioestadística (respuestas 24–48h).
...
- Diseñar estudio viable, ético, y bien justificado.
- Comunicar efectivamente (escrito y oral).

### Sesiones Sincrónicas (4h total)
...
1. **Protocolo de Investigación Mini** (~35–40 horas):
   - Estudiante (individual o dupla, a elección) diseña protocolo de investigación original sobre tema urológico de su interés.
   - **Estructura** (5–8 páginas totales):
     1. **Título** claro, descriptivo (~1 línea).
     2. **Pregunta PICO** bien formulada (1–2 líneas).
     3. **Justificación** (1–1.5 páginas): ¿por qué es importante? ¿qué brecha de conocimiento llena? Referencias a literatura.
     4. **Objetivos** (0.5 pág.):
        - Objetivo primario (1 línea).
        - Objetivos secundarios (≥1, ≤3; cada 1 línea).
     5. **Métodos** (2–2.5 pág.):
        - Diseño: tipo, justificación de por qué este diseño vs. otros.
        - Población: criterios inclusión/exclusión, N estimado.
        - Intervención/Exposición: descripción detallada.
        - Medidas de resultado: primaria (definición operacional), secundarias.
        - Otras: variables confundidoras, cómo se medirán, plan de análisis (conceptual, no numérico).
     6. **Consideraciones Éticas** (0.5–1 pág.):
        - Consentimiento informado: cómo/cuándo.
        - Riesgos/beneficios: análisis.
        - Confidencialidad: medidas.
        - Comité ético: necesario sí/no, justificación.
...
2. **Revisión y Refinamiento** (~5–10 horas):
   - Estudiante recibe feedback formativo (por pares en Sem 14, feedback del instructor).
   - Revisa protocolo: claridad, coherencia, viabilidad, ética.
   - Versión final mejorada para presentación oral.

#### Reflexión (≈9 horas)
- **Journal reflexivo final** (2 entradas):
  - Antes de protocolo: ¿qué pregunta quiero responder? ¿Por qué?
  - Post-feedback: ¿qué cambió en mi pensamiento? ¿Cuál es el mayor reto ético/metodológico de mi estudio?

#### Apoyo Extenso
- **Plantilla de protocolo** (Word/Google Docs, pre-llenado parcialmente con ejemplos).
- **Taller asincrónico**: "Escribiendo tu protocolo de investigación" (video, 20 min; secciones por sección).
- **Revisión por pares** (Sem 14): 2–3 compañeros dan feedback (plantilla guiada).
- **Office hours intensivas** (Sem 14–15): 1-a-1 con instructor, ~10 horas disponibles, signups first-come-first-served.
- **Exemplars**: 2–3 protocolos modelo de estudiantes anteriores (anonimizados), depositados en LMS.
- **Rubrica de protocolo** (entregada en Sem 1): estudiante sabe exactamente qué se evalúa.

---

## Resumen de Horas Independientes por Tipo

| Tipo de Trabajo | Horas | Notas |
|----------|-------|-------|
...
4. **Diversidad cognitiva**: Actividades combinan análisis (appraisal), síntesis (matrices), creatividad (protocolo), comunicación (presentación), reflexión (journales). Esto atiende múltiples estilos de aprendizaje.

5. **Inclusión**: Lecturas prioritarias disponibles en español o inglés simple. Videos tienen subtítulos. Office hours flexibles (síncronas + asincrónicas).

---

## Evaluación Formativa (No Calificada, Pero Crítica)

- Micro-reflexiones/journales: No son evaluadas, pero se revisan; feedback del instructor.
- Ejercicios en taller: Feedback in vivo; no calificado, pero obligatorio para aprendizaje.
- Revisión por pares (Sem 14): Estudiantes dan feedback a compañeros; no calificado, pero desarrolla pensamiento crítico.

El objetivo de evaluación formativa es **mantener aprendizaje en carril** y **dar feedback oportuno**.

---

## Conclusión

Este esquema de actividades y tareas está diseñado para:
- Repartir 192 horas de trabajo equilibradamente entre contacto (30h) e independiente (162h).
- Progresar lógicamente: fundamentos → diseños → ética → appraisal → integración.
- Desarrollar competencias prácticas (búsqueda, appraisal, diseño) y blandas (comunicación, reflexión).
- Proporcionar abundante andamiaje y apoyo sin ser prescriptivo.
- Culminar en un producto auténtico (protocolo) que demuestre integración de aprendizaje.
